        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <a href="{{ route('dashboard.pimpinan.create') }}" class="btn btn-primary btn-rounded btn-fw mb-4" style="float: inline-end; margin-right: 14px;"><i class="fas fa-plus"></i> Tambah</a>
                </div>
