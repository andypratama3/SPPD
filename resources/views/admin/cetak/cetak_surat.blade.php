...
<html lang="en">
  <head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('asset_cetak/bootstrap-5.1.3-dist/css/bootstrap.min.css') }}" /> --}}
  ...
  <body>
    ...
    {{-- LAMPIRAN - 1 --}}
    <div class="container-fluid lampiran-1 container-0">
      ...
      <div class="row d-flex justify-content-between">
        ...
        <div class="col-5 right-container">
          <table class="mb-3">
            ...
            <tr>
              <td>Pada tanggal</td>
              <td class="px-3">: {{ $tgl_sekarang_formated }}</td>
            </tr>
          </table>
    ...
    {{-- RINCIAN BIAYA --}}
    <div class="container-fluid rincian-biaya container-0">
        <div class="row">
            ...
            <table class="tabel">
              <tr>
                ...
                @foreach ($nomor_surat as $nomor)
                    <td>{{ $surat->nomor_surat }} {{ $nomor->nomor_surat }}</td>
                @endforeach
              </tr>
              <tr>
                <td>Tanggal</td>
      ...
      <div class="container-fluid rincian-biaya container-1" style="margin-bottom: 320px;">
        <div class="row">
          <table class="tabel">
    ...
    {{-- LAMPIRAN - 2 --}}
    <div class="container-fluid lampiran-2 container-0">
        <div class="row">
      ...
      <div class="container-fluid lampiran-2 container-1 mt-3">
        <div class="row">
          <table class="tabel">
            <!-- II -->
            <tr>
