...
<html lang="en">
  ...
  <body>
        ...
        <table>
          <tr>
            ...
            <td colspan="3" style="width: 25%">
              Dr. Heriad Daud Salusu, S.Hut., M.P.
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td colspan="3">
              <p class="my-0 py-0">Sri Ngapiyatun, S.P., M.P.</p>
              <p class="my-0 py-0">NIP. 19770827 200112 2 002</p>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td colspan="3">
              <p class="my-0 py-0">a. Pembina Utama Muda, IV/c</p>
              <p class="my-0 py-0">b. Dosen</p>
              <p class="my-0 py-0">c. -</p>
            </td>
          </tr>
          <tr>
            <td>Maksud Perjalanan Dinas</td>
            <td colspan="3">Pengantaran Mahasiswa Magang Industri 1</td>
          </tr>
          <tr>
            <td>Angkutan yang digunakan</td>
            <td colspan="3">Darat</td>
          </tr>
          <tr>
            <td>
            ...
            <td colspan="3">
              <p class="my-0 py-0">Samarinda</p>
              <p class="my-0 py-0">
                PT. Perkebunan Kaltim Utama I, Estate 2, Jawa, Kec. Sanga-sanga,
                Kukar, Kaltim
              </p>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="3">
              <p></p>
              <p class="my-0 py-0">a. Politeknik Pertanian Negeri Samarinda</p>
              <p class="my-0 py-0">b. 524111</p>
            </td>
          </tr>
          <tr>
    ...
    <div class="container-fluid mt-3 container-3">
      <div class="row d-flex justify-content-between">
